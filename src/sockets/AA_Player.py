...
def crearPerfil(ip, puerto):
    ...
    print ("Has accedido al menu de creación de perfiles, introduce los siguientes datos para continuar: ")
...
def editarPerfil(ip, puerto):
    ...
    print ("Has accedido al menu de edición de perfiles, introduce los siguientes datos para cambiar tu contraseña: ")
    ...
    while opcion != 4:
        ...
        if opcion == "1":
            try:
                ...
                print("En este momento no se pueden crear perfiles, intentelo de nuevo mas tarde")
        elif opcion == "2":
            try:
                editarPerfil(IP, PUERTO)
            except ConnectionRefusedError:
                print("En este momento no se pueden editar perfiles, intentelo de nuevo mas tarde")
        elif opcion == "3":
